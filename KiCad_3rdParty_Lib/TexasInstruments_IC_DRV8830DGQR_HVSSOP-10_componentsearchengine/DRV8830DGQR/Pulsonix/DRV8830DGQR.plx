...
(library Library_1
	...
	(compDef "DRV8830DGQR" (originalName "DRV8830DGQR") (compHeader (numPins 11) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "ISENSE") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "10" (pinName "SCL") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "9" (pinName "SDA") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "A1") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "A0") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "FAULTN") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/drv8830.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "DRV8830DGQR.stp")
